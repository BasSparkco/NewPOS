        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedSlug = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_Currencies_BaseCurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncVersion = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    EnrollmentCodeHash = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    EnrolledAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsRevoked = table.Column<bool>(type: "boolean", nullable: false),
                    RevokedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeviceSecretHash = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingCountedAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ExpectedCashAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    DiscrepancyAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    CurrencyCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    IsSharedSession = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDiscrepancy = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            // Global reference currencies. The SQLite migration history seeds these via a one-off
            // hand-authored migration (AddCurrenciesAndStorePolicy) rather than model-level HasData,
            // so a from-scratch schema squash does not replay it automatically — this mirrors the same
            // three rows (same ids/codes/rates) so a fresh Postgres install has the same baseline data
            // a fresh SQLite install gets. Found and fixed during the live PostgreSQL rehearsal: without
            // this, tenant provisioning fails with "Currency 'ILS' is not available."
            migrationBuilder.Sql(
                @"INSERT INTO ""Currencies"" (""Id"", ""Code"", ""Name"", ""Symbol"", ""CreatedAt"", ""UpdatedAt"", ""IsDeleted"")
VALUES ('a0000001-0000-0000-0000-000000000001', 'ILS', 'Israeli Shekel', '₪', '2026-04-02T12:00:00Z', '2026-04-02T12:00:00Z', FALSE);");

            migrationBuilder.Sql(
                @"INSERT INTO ""Currencies"" (""Id"", ""Code"", ""Name"", ""Symbol"", ""CreatedAt"", ""UpdatedAt"", ""IsDeleted"")
VALUES ('a0000001-0000-0000-0000-000000000002', 'USD', 'US Dollar', '$', '2026-04-02T12:00:00Z', '2026-04-02T12:00:00Z', FALSE);");

            migrationBuilder.Sql(
                @"INSERT INTO ""Currencies"" (""Id"", ""Code"", ""Name"", ""Symbol"", ""CreatedAt"", ""UpdatedAt"", ""IsDeleted"")
VALUES ('a0000001-0000-0000-0000-000000000003', 'EUR', 'Euro', '€', '2026-04-02T12:00:00Z', '2026-04-02T12:00:00Z', FALSE);");
        }
